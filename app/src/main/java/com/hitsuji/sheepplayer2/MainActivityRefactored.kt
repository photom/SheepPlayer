...
/**
 * Refactored MainActivity following SOLID principles:
 * - Single Responsibility: Delegates specific tasks to dedicated handlers
 ...
 */
class MainActivityRefactored : AppCompatActivity(), NavigationController, FragmentNotifier {
    ...
    private fun setupCallbacks() {
        ...
        musicDataHandler.setCallback(object : MusicDataHandler.MusicDataCallback {
            ...
            override fun onMusicLoadError(message: String) {
                Toast.makeText(this@MainActivityRefactored, message, Toast.LENGTH_LONG).show()
            }
